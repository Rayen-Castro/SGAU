...
export function TeacherPanel({
  ...
  const getString = (val) => {
    ...
    if (typeof val === "object") return val.nombre || val.correo || val._id || "";
    return String(val);
  };
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    transition: "all 0.2s",
                    boxShadow: activo ? "0 2px 8px rgba(0,74,153,0.15)" : "none",
                  }}
                >
                  <div
                    style={{
            ...
            >
              ...
              >
                ...
                <div style={{ textAlign: "right" }}>
                  ...
                  <div style={{ fontSize: "11px", opacity: 0.8 }}>
                    👥 {asignaturaActiva.estudiantesInscritos?.length || 0} alumnos
                  </div>
                </div>
              </div>
              ...
              {msgNotas && (
                <div
                  style={{
                    ...
                    fontSize: "12px",
                    fontWeight: "bold",
                    backgroundColor: msgNotas.includes("Error") ? "#fff5f5" : "#f0fff4",
              ...
              <div style={{ overflowX: "auto", padding: "16px" }}>
                ...
                >
                  ...
                  <tbody>
                    {asignaturaActiva.estudiantesInscritos?.map((alumno, rowIdx) => {
                      ...
                      return (
                        <tr
                          key={alumno._id}
                          style={{
                            backgroundColor: rowIdx % 2 === 0 ? "white" : "#f7fafc",
                        ...
                        >
                          ...
                          {asignaturaActiva.evaluaciones?.map((ev, idx) => {
                            const registro = buscarNotaEnBase(alumno._id, ev.nombreEval);
                            return (
                              <td
                                key={idx}
                              ...
                              >
                                <input
                                  ...
                                  max="7.0"
                                  placeholder="—"
                                  defaultValue={registro ? registro.calificacion : ""}
                                  onBlur={(e) =>
                                    guardarNotaServidor(
                                      alumno._id,
                                      ev.nombreEval,
                                  ...
                                  onFocus={(e) =>
                                    (e.target.style.border = "1px solid #004a99")
                                  }
                                  onBlurCapture={(e) =>
                                    (e.target.style.border = "1px solid #cbd5e0")
                                  }
                                />
                                {registro?.modificadoPor && (
                                  <div style={{ fontSize: "9px", color: "#a0aec0", marginTop: "2px" }}>
