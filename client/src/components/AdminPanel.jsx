            ...
            {tieneExamenIntegral && (
              <div style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "13px" }}>
                ...
                <input
                  ...
                  onChange={(e) => setPorcentajeExamenIntegral(Number(e.target.value))}
            ...
            {listaAsignaturas.map((asig) => (
              ...
              >
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "6px" }}>
                  ...
                  <span style={{ fontSize: "10px", background: "#edf2f7", padding: "2px 6px", borderRadius: "4px", color: "#718096" }}>
                    {asig.codigo}
                  </span>
                </div>
                ...
                <div style={{ color: "#4a5568", marginBottom: "4px" }}>
                  👨‍🏫 <strong>Docente:</strong> {asig.docente?.nombre || "No asignado"}
                </div>
                ...
                {(asig.facultad || asig.carrera) && (
                  <div style={{ color: "#4a5568", marginBottom: "4px" }}>
                    ...
                    {asig.carrera && <span style={{ color: "#718096" }}>{asig.carrera}</span>}
                  </div>
                )}

                {/* Alumnos */}
                <div style={{ color: "#4a5568", marginBottom: "4px" }}>
                  👥 <strong>Alumnos:</strong> {asig.estudiantesInscritos?.length || 0} inscritos
                </div>
                ...
                <div style={{ display: "flex", gap: "6px", flexWrap: "wrap" }}>
                  {asig.tieneAyudantia ? (
                    <span style={{
                      ...
                      background: "#ebf8ff", color: "#2b6cb0", border: "1px solid #bee3f8", fontWeight: "bold"
                    }}>
                      🤝 Con Ayudantía
                    </span>
                  ) : (
                  ...
                  {asig.tieneExamenIntegral ? (
                    <span style={{
                      fontSize: "10px", padding: "2px 8px", borderRadius: "20px",
                      background: "#fffaf0", color: "#c05621", border: "1px solid #fbd38d", fontWeight: "bold"
                    }}>
